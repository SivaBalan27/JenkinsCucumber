Feature: Verifying the Room type in Search Hotel page.
 ...
 Scenario Outline: Verifying adactin login details with valid credentials
  ...
  When User should Select the first Hotel
  ...
  Then User should verify Order No
     Examples:
      ...
      |Sivabalan|Aug@2020|Sydney |Hotel Sunshine|Double|2 - Two|23/08/2020|24/08/2020|2 - Two|2 - Two|Siva|Balan|Chennai|1234123412341234|American Express|December|2021|222|
      |Sivabalan|Aug@2020|Sydney |Hotel Sunshine|Deluxe|2 - Two|23/08/2020|24/08/2020|3 - Three|2 - Two|Siva|Balan|Chennai|1234123412341234|Other|December|2021|222|
      |Sivabalan|Aug@2020|Sydney |Hotel Sunshine|Super Deluxe|2 - Two|23/08/2020|24/08/2020|4 - Four|2 - Two|Siva|Balan|Chennai|1234123412341234|Master Card|December|2021|222|
